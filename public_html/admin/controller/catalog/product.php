...
class ControllerCatalogProduct extends Controller {
		...
		foreach ($product_attributes as $product_attribute) {
			...
			if ($attribute_info) {
				$data['product_attributes'][] = array(
					...
					'list_type' 										=> $attribute_info['list_type'],
					'list_values' 									=> $this->model_catalog_attribute->getAttributeValues($product_attribute['attribute_id'])
				);
			}
		}
    ...
    // id товара
		...
		foreach ($product_images as $product_image) {
			if (!empty($product_info) && is_file(DIR_IMAGE . $product_image['image'])) {
				if (strpos($product_image['image'], ".webp") !== false || strpos($product_image['image'], ".avif") !== false){
