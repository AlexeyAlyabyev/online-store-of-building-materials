...
class ControllerSettingSetting extends Controller {
    ...
    if (isset($this->request->post['config_whatsapp_telephone'])) {
			$data['config_whatsapp_telephone'] = $this->request->post['config_whatsapp_telephone'];
		} else {
			$data['config_whatsapp_telephone'] = $this->config->get('config_whatsapp_telephone');
		}
   ...
   if (isset($this->request->post['config_color_class_id'])) {
    ...
    $data['config_color_class_id'] = $this->config->get('config_color_class_id');
  }

  $this->load->model('localisation/color_class');

  $data['color_classes'] = $this->model_localisation_color_class->getLengthClasses();
	...
	protected function validate() {
		...
		// if ((utf8_strlen($this->request->post['config_whatsapp_telephone']) < 3) || (utf8_strlen($this->request->post['config_whatsapp_telephone']) > 32)) {
		// 	$this->error['telephone'] = $this->language->get('error_telephone');
		// }
