...
class ControllerExtensionModuleDreamFilter extends Controller {
	...
	public function index($setting) {
		...
		$popper_action .= (strpos($popper_action, '?') !== false ? '&' : '?' ). $this->parseArguments($this->request->get, ['path' => 'rdrf_path', 'manufacturer_id' => 'rdrf[man][0]']);
		...
		$data['view']['mobile']['button_id'] = 'dream_filter_toggler';
